      ...
      <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 class="font-display font-semibold text-[#0F172A] dark:text-[#F8FAFC] text-xl leading-none">Class Management</h1>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] p-6 shadow-sm dark:shadow-indigo-500/5">
             ...
             <p class="text-3xl font-display font-bold text-[#0F172A] dark:text-[#F8FAFC]">92%</p>
             <div class="mt-2 text-[10px] text-[#94A3B8] font-semibold">26/28 students submitted</div>
          </div>
          <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] p-6 shadow-sm dark:shadow-indigo-500/5 col-span-1 md:col-span-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] overflow-hidden shadow-sm dark:shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
               <div class="px-6 py-5 border-b border-[#F1F5F9] dark:border-[#1E293B] flex items-center justify-between">
                 ...
                 <div class="flex items-center gap-2">
                    <button class="p-2 rounded-xl text-[#64748B] dark:text-[#94A3B8] hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-all">
               ...
               <div class="overflow-x-auto">
                 <table class="w-full text-left">
                      <tr class="bg-[#F8FAFC] dark:bg-[#0D1425] border-b border-[#F1F5F9] dark:border-[#1E293B]">
                       ...
                       <tr class="hover:bg-[#FDFDFF] dark:hover:bg-white/5 transition-colors cursor-pointer group">
                         <td class="px-6 py-4">
                           <div class="flex items-center gap-3">
                              ...
                              <div class="min-w-0">
                                <p class="text-sm font-bold text-[#0F172A] dark:text-[#F8FAFC] truncate">${s.name}</p>
                          ...
                          <td class="hidden sm:table-cell px-6 py-4">
                            <div class="flex items-center gap-2">
                               <span class="text-xs font-bold text-[#475569] dark:text-[#F8FAFC]">${s.attendance}%</span>
                               <div class="w-16 h-1.5 bg-gray-100 dark:bg-[#0D1425] rounded-full overflow-hidden border border-transparent dark:border-[#1E293B]">
                          ...
                          <td class="hidden sm:table-cell px-6 py-4">
                             <span class="text-xs font-semibold text-[#0F172A] dark:text-[#F8FAFC] tracking-tighter">${(s.gpa).toFixed(2)}</span>
                          </td>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] p-6 shadow-sm dark:shadow-indigo-500/5">
               ...
               <div class="space-y-5">
                  <div>
                    ...
                    <p class="text-xs font-semibold text-[#475569] dark:text-[#F8FAFC] leading-relaxed">${cls.name}</p>
                  </div>
                  <div class="grid grid-cols-2 gap-4">
                     ...
                     <div>
                       ...
                       <p class="text-xs font-semibold text-[#0F172A] dark:text-[#F8FAFC] uppercase">${cls.students} Enrolled</p>
                     </div>
                  </div>
                  <div>
                    <p class="text-[10px] font-semibold text-[#94A3B8] uppercase tracking-widest mb-1">Schedule & Room</p>
                   <p class="text-xs font-semibold text-[#475569] dark:text-[#F8FAFC] leading-relaxed">${cls.schedule} · ${cls.room}</p>
                  </div>
               </div>
            </div>
            ...
            <!-- Recent Classwork -->
            <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] p-6 shadow-sm dark:shadow-indigo-500/5">
               <h3 class="font-display font-semibold text-[#0F172A] dark:text-[#F8FAFC] text-sm mb-6 flex items-center gap-2 font-display">
                  ...
                  ${classworks.map(cw => `
                    <div class="group cursor-pointer" onclick="EP.actions.gradeSubmissions('${cw.title}')">
                       <div class="flex justify-between items-start mb-2">
                          <div>
                             <p class="text-xs font-bold text-[#475569] dark:text-[#F8FAFC] group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">${cw.title}</p>
                       ...
                       <div class="h-1.5 w-full bg-gray-100 dark:bg-[#0D1425] rounded-full overflow-hidden border border-transparent dark:border-[#1E293B]">
