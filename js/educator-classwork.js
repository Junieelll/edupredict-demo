    ...
    document.getElementById('content').innerHTML = `
      <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between gap-4">
          <div>
            <h1 class="font-display font-bold text-[#0F172A] text-[14px] md:text-2xl">Classwork Management</h1>
            <p class="text-[#64748B] text-sm mt-0.5">Track and grade ${classworks.length} active assignments</p>
          </div>
        ...
        <div class="grid grid-cols-1 gap-4">
          ${classworks.map(cw => {
            ...
            return `
              <div class="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-sm hover:border-indigo-200 transition-all group">
                <div class="flex flex-col md:flex-row md:items-center gap-5">
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-4 mb-2">
                      <div>
                        <h3 class="font-display font-bold text-[#0F172A] text-base group-hover:text-indigo-600 transition-colors">${cw.title}</h3>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-5 mt-6 pt-5 border-t border-[#F8FAFC]">
                      <div class="flex-1 min-w-0">
                        <div class="flex justify-between items-center mb-1.5 text-[10px] font-bold text-[#94A3B8] uppercase tracking-wider">
                      ...
                      <div class="flex items-center gap-2 pt-2 lg:pt-0 lg:ml-auto">
                        <div class="flex gap-2.5">
                          <button onclick="EP.actions.gradeSubmissions('${cw.title}')" class="flex-1 bg-indigo-500 hover:bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest py-3 px-6 rounded-xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95">
                            Grade Submissions
                          </button>
                          <button onclick="EP.notify('Assignment editor not available', 'info')" class="w-12 h-12 flex items-center justify-center bg-white border border-[#E2E8F0] text-[#64748B] hover:text-indigo-600 hover:border-indigo-200 rounded-xl transition-all hover:shadow-sm active:scale-95">
