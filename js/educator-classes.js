      ...
      <div class="max-w-7xl mx-auto space-y-6">
        <div class="flex flex-row items-center justify-between gap-4">
          <div>
            ...
            <p class="text-[#64748B] dark:text-[#94A3B8] text-xs mt-0.5">Manage and track performance across your ${classes.length} active courses</p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ${[
            ...
            <div class="bg-white dark:bg-[#141D33] rounded-2xl border border-[#E2E8F0] dark:border-[#1E293B] p-5 shadow-sm flex items-center gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ${classes.map(cls => `
            <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] overflow-hidden shadow-sm dark:shadow-indigo-500/10 hover:shadow-md transition-all group">
              ...
              <div class="p-6">
                <h4 class="font-display font-bold text-[#0F172A] dark:text-[#F8FAFC] mb-1 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">${cls.name}</h4>
                <p class="text-xs text-[#64748B] dark:text-[#94A3B8] line-clamp-2 mb-4 leading-relaxed">${cls.description}</p>
                
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-[#F1F5F9] dark:border-[#1E293B]">
                  <div>
                    <p class="text-[10px] font-bold text-[#94A3B8] uppercase mb-1">Students</p>
                    <div class="flex items-center gap-1.5 capitalize text-xs font-semibold text-[#475569] dark:text-[#F8FAFC]">
          ...
          <div onclick="EP.actions.newClass()" class="bg-[#F8FAFC] dark:bg-[#0D1425] rounded-3xl border-2 border-dashed border-[#E2E8F0] dark:border-[#1E293B] p-6 flex flex-col items-center justify-center text-center gap-3 min-h-[360px] group cursor-pointer hover:border-indigo-300 dark:hover:border-indigo-500/50 hover:bg-indigo-50/30 dark:hover:bg-indigo-500/5 dark:shadow-indigo-500/5 transition-all">
            <div class="w-14 h-14 rounded-2xl bg-white dark:bg-[#141D33] shadow-sm border border-[#E2E8F0] dark:border-[#1E293B] flex items-center justify-center text-indigo-500 dark:text-indigo-400 group-hover:scale-110 transition-transform">
              ${EP.getIcon('plus', 'w-7 h-7')}
            </div>
            <div>
              <p class="font-display font-semibold text-[#475569] dark:text-[#F8FAFC] group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Add New Class</p>
