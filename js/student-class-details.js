               ...
               <div class="bg-white dark:bg-[#141D33] rounded-3xl border border-[#E2E8F0] dark:border-[#1E293B] p-6 shadow-sm">
                 ...
                 <div class="space-y-4">
                   ${announcements.length ? announcements.map(a => `
                     <div class="p-4 bg-amber-50/50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 rounded-2xl relative overflow-hidden group hover:bg-amber-100/50 dark:hover:bg-amber-500/15 transition-colors">
                       ...
                       <div class="flex justify-between items-start mb-1">
                          <p class="text-xs font-semibold text-amber-800 dark:text-amber-400">${a.title}</p>
                          <span class="text-[9px] font-medium text-amber-600/70 dark:text-amber-400/50 uppercase">${new Date(a.date).toLocaleDateString()}</span>
                       </div>
                       <p class="text-[11px] text-amber-900/70 dark:text-amber-200/70 leading-relaxed">${a.text}</p>
                     </div>
                   `).join('') : `
